...
if (process.env.GATSBY_DB_NODES === `loki`) {
  console.info(`The experimental Loki backend for Gatsby has been removed. Falling back to redux. If this causes problems for you, please file an issue on GitHub and tag @pvdz.`);
