...
const PageLayouts = ({ layoutData, theme, containerIsScrollable, updateParallaxState }) => {
  ...
  const layouts = {
    ...
    page_Components_Contents_Carousel: Carousel,
    page_Components_Contents_ImageSubnav: ImageSubnav,
    page_Components_Contents_YoutubeVideo: YouTubeVideo,
    page_Components_Contents_FullscreenPhoto: FullscreenPhoto,
