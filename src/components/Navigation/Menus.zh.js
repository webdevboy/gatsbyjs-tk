      ...
      >
        {wordpress.menus &&
          ...
          <li className="passive-nav-item">
            <Link to={convertLinkLocale('/zh/about', i18n.language)} onClick={((e) => handleNavClick(e, convertLinkLocale('/about', i18n.language)))}>
              {t('nav-about')}
            </Link>
          </li>
        {!isAuthenticated() && (<li className="passive-nav-item">
